...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "MS Tube Downloader is a web application for downloading YouTube videos and audio." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Download YT content in seconds" },
      { property: "og:description", content: "MS Tube Downloader is a web application for downloading YouTube videos and audio." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Download YT content in seconds" },
      { name: "twitter:description", content: "MS Tube Downloader is a web application for downloading YouTube videos and audio." },
